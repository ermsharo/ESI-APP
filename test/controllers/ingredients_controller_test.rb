...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { id: @ingredient.id, name: @ingredient.name, relevance: @ingredient.relevance } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { id: @ingredient.id, name: @ingredient.name, relevance: @ingredient.relevance } }
